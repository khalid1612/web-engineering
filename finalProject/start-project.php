...
<?php require_once "php/startProject.php" ?>
<!DOCTYPE html>
<html lang="en">

<head>

  <title>Share a new project</title>
      ...
      <div class="col col-xl-12 order-xl-2 col-lg-6 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
        <div class="ui-block">
          <div class="ui-block-title">
            <h6 class="title">Start a new project</h6>
          </div>
          <div class="ui-block-content">
                ...
                <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                  <div class="form-group label-floating">
                    <div class="form-group label-floating">
                      ...
                      <input name="type" class="form-control" placeholder="android,web..." type="text">
                    </div>
                  </div>
                </div>
                <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                        ...
                        <?php
                            foreach ($userDetails as $user) {
                                if ($user->id() == $_SESSION['id']){
                                    ...
                                    echo
                                        '
                                <option title="' . $user['fullName'] . '"data-content=\'<div class="inline-items">
          											<div class="author-thumb">
          												<img src="'.getUserImg($user->id()).'" class="img28" alt="'.$user['nickName'].'">
          											</div>
                ...
                <div class="col col-lg-8 col-md-8 col-sm-12 col-12">
                  ...
                  <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                      <div class="form-group date-time-picker">
                          <input type="text" name="datetimepicker" placeholder="Project estimate end at"/>
            ...
            <div class="row justify-content-center mt50">
              ...
              <div class="col col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
                <input type="submit" name="startProject" class="btn btn-green btn-lg full-width btn-icon-left" value="Start Project"/>
